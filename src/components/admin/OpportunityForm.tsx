...
import { Upload, X, Image, Video, FileText, Plus, Calendar } from 'lucide-react';
...
export function OpportunityForm({ onSuccess, onCancel }: OpportunityFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.createOpportunity(formData, selectedFiles);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Imkoniyat sarlavhasi..."
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Заголовок возможности..."
                  required
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="ends_at">
                {language === 'uz' ? 'Tugash sanasi' : language === 'ru' ? 'Дата окончания' : 'End Date'}
                <span className="text-red-500">*</span>
              </Label>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Содержание возможности..."
                  rows={8}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Opportunity content..."
                  rows={8}
                  required
                />
              </div>
